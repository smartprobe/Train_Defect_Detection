...
if __name__ == '__main__':
  ...
  for i in range(num_images):
      ...
      if vis:
          ...
          im2show = np.copy(im)
          img_name = imdb.image_path_at(i).split("/")[-1].split(".")[0]
          print("image path:", imdb.image_path_at(i))
      ...
      for j in xrange(1, imdb.num_classes):
          ...
          if inds.numel() > 0:
            ...
            if vis:
              im2show, results = vis_detections(im2show, im_crop , imdb.classes[j], cls_dets.cpu().numpy(), thresh, 'crop_image', img_name, results)
